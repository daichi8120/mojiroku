...
const en: Dict = {
  ...
  meeting: {
    translation: {
      ...
      enable: "Translate",
      disable: "Turn off",
      description: "Translate live captions into Japanese or English on this Mac. Check the original transcript when accuracy matters.",
      downloadHint: "Requires at least 16 GB of RAM. First use downloads a 5.68 GB translation model. Translation shares processing time with transcription and other local AI tasks.",
      ...
      skipped: "Translation is behind. Older pending captions were skipped to catch up; the original transcript remains on the left.",
