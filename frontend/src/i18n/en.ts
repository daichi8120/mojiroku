...
const en: Dict = {
  ...
  meeting: {
    translation: {
      ...
      enable: "Translate",
      disable: "Turn off",
      description: "Translate captions on this Mac. Completed translations are saved with the meeting.",
      downloadHint: "Requires 16 GB RAM and a 5.68 GB model. Prepare the model in Settings before a meeting.",
      about: "Info",
      retained: "Completed translations stay available when you navigate, change language, or turn translation off.",
      savedTitle: "Live translations",
      savedHint: "Saved live captions; wording may differ from the final transcript.",
      savedEmpty: "No completed live translations were saved for this recording.",
      saveInvalid: "Could not prepare translations for saving. Recording is still running; translations are retained.",
      savedFailed: "Could not load saved translations.",
      historyFull: "Translation history is full. Recording continues; stop and save to start a new meeting.",
      temporary: "Temporary preview only. Translations are cleared when you turn this off, change language, leave this screen, or stop recording. They are not saved.",
      preparing: "Preparing translation…",
      downloading: "Downloading model…",
      waiting: "Waiting for another local AI task…",
      translating: "Translating…",
      listening: "Waiting for live captions…",
      pending: "pending",
      unavailable: "Live translation is unavailable on this Mac. It requires at least 16 GB of RAM. Recording continues.",
      failed: "Translation paused. Check your connection and available storage, then retry. Recording continues.",
      retry: "Retry translation",
      skipped: "Some older captions were skipped to keep up.",
      results: "Translated captions",
      tooLong: "This caption is too long to translate live.",
      rowFailed: "Translation unavailable.",
      rowSkipped: "Skipped to catch up.",
      rowQueued: "Waiting to translate…",
    },
    idle: {
      title: "Record a meeting",
  ...
  settings: {
    ...
    language: {
      ...
      auto: "Auto-detect",
      autoJaEn: "Auto (Japanese / English)",
