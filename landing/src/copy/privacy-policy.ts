...
export const ja: PrivacyPolicyCopy = {
  ...
  contact: {
    ...
    body: [
      ...
      "このポリシーやデータの扱いについての質問、開示等の請求、苦情は、上のアドレスで受け付けています。公開のやりとりでよければ、GitHub の Issue でもかまいません。",
    ],
...
export const en: PrivacyPolicyCopy = {
  ...
  contact: {
    ...
    body: [
      ...
      "Questions about this policy, requests regarding your information, and complaints are all welcome at the address above. If a public thread is fine with you, a GitHub issue works too.",
    ],
